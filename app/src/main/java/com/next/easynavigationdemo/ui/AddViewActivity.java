        ...
        navigationBar.titleItems(tabText)
                ...
                .setOnTabClickListener(new EasyNavigationBar.OnTabClickListener() {
                    ...
                    public boolean onTabSelectEvent(View view, int position) {
                        if(position == 1){
                            navigationBar.normalTextColor(Color.GRAY);
                            navigationBar.navigationBackground(Color.BLACK);
                            navigationBar.updateNavigation(true);
                        }else {
                            navigationBar.normalTextColor(Color.BLACK);
                            navigationBar.navigationBackground(Color.WHITE);
                            navigationBar.updateNavigation(true);
                        }
                        return false;
                    }
